...
export default {
  ...
  watch:{
     $route(to,from){
           ...
           console.log('a   ',this.routerQueue[this.routerQueue.length-1]);
           console.log('b   ',to.path + '=>'+from.path)

       if(this.routerQueue[this.routerQueue.length-1] == to.path + '=>'+from.path){
        this.routerQueue.pop();
        console.info('返回上一页');
        this.transitionName="slide-right";
      }else{
        this.routerQueue.push(from.path + '=>'+to.path);
